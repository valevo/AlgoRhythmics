...
from v5.Nets.RhythmNetwork import BarEmbedding, RhythmNetwork
from v5.Nets.MelodyNetwork import MelodyNetwork

from v5.Data.DataGenerators import CombinedGenerator
