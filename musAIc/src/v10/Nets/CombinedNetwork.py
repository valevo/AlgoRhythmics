...
from v10.Nets.RhythmEncoder import BarEmbedding, RhythmEncoder
from v10.Nets.RhythmNetwork import RhythmNetwork
from v10.Nets.MelodyEncoder import MelodyEncoder
from v10.Nets.MelodyNetwork import MelodyNetwork
from v10.Nets.MetaPredictor import MetaPredictor

from v10.Data.DataGenerators import CombinedGenerator
...
class CombinedNetwork(Model):
    ...
    def __init__(self, context_size, melody_bar_len, meta_embed_size,
        ...
        meta_data = Input(shape=(10,), name="meta_data")
        meta_embedder = Dense(meta_embed_size, activation="softplus",
                              name="meta_embed", kernel_regularizer="l2")
        meta_embedded = meta_embedder(meta_data)
        ...
        if generation:
            ...
            super().__init__(inputs=[*rhythm_contexts, rhythms, melody_contexts, 
                                     meta_data, meta_data_prev,
                                     lead_rhythm, lead_melody],
                             outputs=[rhythm_preds, melody_preds, meta_data_recon])
