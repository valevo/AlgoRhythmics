...
class NNPlayer9C(Player):
    ...
    def __init__(self, _id, ins_panel=None):
        ...
        self.metaEmbedder = MetaEmbedding.from_saved_custom(trainings_dir + 'meta/')

        metaPredictor = MetaPredictor.from_saved_custom(trainings_dir + 'meta/')

        weights_folder = trainings_dir + 'weights/_checkpoint_19/'
    ...
    def prepare_meta_data(self):
        ...
        self.unembeddedMetaData = metaData
